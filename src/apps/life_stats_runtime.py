    ...
    def build_latest_life_stats(
        ...
        *,
        ...
        stats = {
            ...
            "m14_grounding_confidence": self._life_tensor_float(conscious_action.get("grounding_confidence"), 0.0),
            "m14_expected_outcome": self._life_tensor_float(conscious_action.get("expected_outcome"), 0.0),
