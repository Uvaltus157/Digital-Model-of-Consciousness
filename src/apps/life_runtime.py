...
class LifeRuntimeMixin:
    ...
    def life_step(self) -> None:
        ...
        # Human-readable inner speech for visualizer.
        decoded_report = self.speech_vocab.decode(out["symbolic_report"]["text_token_ids"][0], skip_special=True)
        target_report = self.speech_teacher.build_report(obs, out)
